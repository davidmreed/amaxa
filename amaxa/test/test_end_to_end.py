    ...
    def test_extracts_from_command_line(self):
        ...
        def select_file(f, *args, **kwargs):
            credentials = """
                ...
                credentials:
                    ...
                    instance-url: '{}'
                """.format(
                os.environ["ACCESS_TOKEN"], os.environ["INSTANCE_URL"]
            )
        ...
        with unittest.mock.patch("builtins.open", m):
            with unittest.mock.patch(
                "sys.argv", ["amaxa", "-c", "credentials.yaml", "extraction.yaml"]
            ):
                return_value = main()
        ...
        self.assertEqual(
            set(["FirstName", "LastName", "AccountId", "Id"]),
            set(contact_reader.fieldnames),
        )
...
00v000000000004,701000000000001,00Q000000000004,Sent
        ...
        with unittest.mock.patch("builtins.open", m):
            with unittest.mock.patch(
                "sys.argv", ["amaxa", "-c", "credentials.yaml", "--load", "load.yaml"]
            ):
                return_value = main()
        ...
        required_names = {
            "Tauron Tourist Outreach",
            "Aerilon Outreach",
            "Caprica City Direct Mailer",
        }
