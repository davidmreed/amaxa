...
class test_Integration_Extraction(unittest.TestCase):
    ...
    def test_query_extracts_self_lookup_hierarchy(self):
        ...
        for c in oc.file_store.get_csv('Account', amaxa.FileType.OUTPUT).writerow.call_args_list:
    ...
    def test_descendents_extracts_object_network(self):
        ...
        for c in oc.file_store.get_csv('Contact', amaxa.FileType.OUTPUT).writerow.call_args_list:
...
class test_Integration_Load(unittest.TestCase):
    ...
    def test_loads_single_object(self):
        ...
        records = [
            {
                'Id': '01t000000000001', 'Name': 'Tauron Taffy', 'IsActive': 'True', 'ProductCode': 'TAFFY_TAUR'
            },
            {
                'Id': '01t000000000002', 'Name': 'Gemenese Goulash', 'IsActive': 'True', 'ProductCode': 'GLSH'
            },
            {
    ...
    def test_loads_complex_hierarchy(self):
        ...
        campaigns = [
            { 'Id': '701000000000001', 'Name': 'Tauron Tourist Outreach', 'IsActive': 'True', 'ParentId': '' },
            { 'Id': '701000000000002', 'Name': 'Aerilon Outreach', 'IsActive': 'True', 'ParentId': '701000000000001' },
            { 'Id': '701000000000003AAA', 'Name': 'Caprica City Direct Mailer', 'IsActive': 'False', 'ParentId': '701000000000001' }
        ]
        leads = [
            { 'Id': '00Q000000000001', 'Company': 'Picon Fleet Headquarters', 'LastName': 'Nagata'},
            { 'Id': '00Q000000000002', 'Company': 'Picon Fleet Headquarters', 'LastName': 'Adama'},
            { 'Id': '00Q000000000003', 'Company': 'Ha-La-Tha', 'LastName': 'Guatrau' },
            { 'Id': '00Q000000000004', 'Company': '[not provided]', 'LastName': 'Thrace' },
        ]
        campaign_members = [
            { 'Id': '00v000000000001', 'CampaignId': '701000000000001', 'LeadId': '00Q000000000001', 'Status': 'Sent' },
            { 'Id': '00v000000000002', 'CampaignId': '701000000000002', 'LeadId': '00Q000000000002', 'Status': 'Sent' },
            { 'Id': '00v000000000003', 'CampaignId': '701000000000003', 'LeadId': '00Q000000000004', 'Status': 'Sent' },
            { 'Id': '00v000000000004', 'CampaignId': '701000000000001', 'LeadId': '00Q000000000004', 'Status': 'Sent' }
        ]
